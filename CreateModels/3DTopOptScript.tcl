...
*createmark loadsteps 1 "loadstep1"2
...
*retainmarkselections 1
*retainmarkselections 0
*setvalue optiresponses id=1 STATUS=2 loadsteplist={loadsteps 1}1
...
*setvalue opticonstraints id=1 STATUS=1 upperbound=0.1
